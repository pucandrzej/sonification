...
# self._build_plot() JEST NAJBARDZIEJ OBCIĄŻAJĄCYM OBLICZENIOWO ZADANIEM,
# KTÓRE DZIEJE SIĘ W CZASIE RZECZYWISTYM KIEDY ZMIENIAMY ILOŚĆ KRZYWYCH NA WYKRESIE
# DLATEGO WTEDY ZDARZA SIĘ OUTPUT_UNDERFLOW
# MOŻNA TEMU ZARADZIĆ - JAK? (DOPUSZCZAM ODPOWIEDŹ "NAIWNĄ"/"TYMCZASOWĄ" BEZ ZMIAN LOGIKI)
